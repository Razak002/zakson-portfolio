...
function Explore() {
  return (
    <div className="w-full min-h-[50vh] flex justify-center items-center px-6">
      <div className="flex flex-col md:flex-row items-center gap-6 p-8 rounded-2xl bg-white/5 backdrop-blur-lg border border-gray-500/20 shadow-lg hover:border-gray-500/40 transition duration-300">
        ...
        <a
          ...
          className="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-r from-gray-200 to-gray-600 text-white hover:scale-110 transition duration-300"
        >

...
export const WORKS = [
  {
    id: 1,
    image: async,
    title: "01__ AI-Powered Team Standups",
    github: "https://github.com/Razak002/async-up",
    demo: "https://async-up.vercel.app/",
    content:
...

   {
    id: 2,
    image: gymnastic,
    title: "02__ CoreX GYM Crib",
    github: "https://github.com/Razak002/corex",
    demo: "https://corex-ruby.vercel.app",
    content:
      "CoreX Gym is a modern fitness platform that offers training programs, expert guidance, and membership options to help you achieve your fitness goals.",
  },

  {
    id: 3,
    image: finflow,
    title: "03__Fintech dashboard",
    ...
    content:
      "Bycrypt is a secure and user-friendly crypto wallet designed for managing digital assets with ease. It provides wallet creation, balance tracking, and seamless transaction features, all within a responsive and modern UI built with React and Next.js.",
  },

  {
    id: 5,
    image: any,
    title: "05__Any2Any Universal File Converter",
    ...
    id: 6,
    image: swapit,
    title: "06__ Crypto wallet",
    github: "https://github.com/Razak002/Deep",
    demo: "https://deep-jet.vercel.app/",
    content:
      "Experience the future of digital finance with our modern crypto wallet engineered for swift, secure, and effortless transactions in seconds.",
  },
